...
return [
    'ctrl' => [
        'title' => $ll . 'tx_bfbn_domain_model_institutionsprache',
        'label' => 'bezeichnung',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'bezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionsprache.bezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'sprache' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionsprache.sprache',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'jahrgangsstufe' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionsprache.jahrgangsstufe',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
