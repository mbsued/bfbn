...
return [
    'ctrl' => [
        'title' => $ll . 'tx_bfbn_domain_model_regierungsbezirk',
        'label' => 'bezeichnung',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'bezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_regierungsbezirk.bezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'kurzbezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_regierungsbezirk.kurzbezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
