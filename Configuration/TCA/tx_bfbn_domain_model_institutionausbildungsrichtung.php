...
return [
    'ctrl' => [
        'title' => $ll . 'tx_bfbn_domain_model_institutionausbildungsrichtung',
        'label' => 'bezeichnung',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'bezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionausbildungsrichtung.bezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'ausbildungsrichtung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionausbildungsrichtung.ausbildungsrichtung',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'schulart' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionausbildungsrichtung.schulart',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'jahrgangsstufe' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionausbildungsrichtung.jahrgangsstufe',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
