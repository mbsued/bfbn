...
return [
    'ctrl' => [
        'title' => $ll . 'tx_bfbn_domain_model_jahrgangsstufe',
        'label' => 'bezeichnung',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'bezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_jahrgangsstufe.bezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'kurzbezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_jahrgangsstufe.kurzbezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
