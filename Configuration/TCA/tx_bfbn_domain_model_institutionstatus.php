...
return [
    'ctrl' => [
        'title' => $ll . 'tx_bfbn_domain_model_institutionstatus',
        'label' => 'bezeichnung',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'bezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionstatus.bezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'langbezeichnung' => [
            'exclude' => true,
            'label' => $ll . 'tx_bfbn_domain_model_institutionstatus.langbezeichnung',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
