...
return [
    'ctrl' => [
        'title' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung',
        'label' => 'nachname',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'nachname' => [
            'exclude' => true,
            'label' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung.nachname',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'vorname' => [
            'exclude' => true,
            'label' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung.vorname',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'geschlecht' => [
            'exclude' => true,
            'label' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung.geschlecht',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'sprache' => [
            'exclude' => true,
            'label' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung.sprache',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'institution' => [
            'exclude' => true,
            'label' => $ll. 'tx_bfbn_domain_model_ergaenzungspruefung.institution',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
